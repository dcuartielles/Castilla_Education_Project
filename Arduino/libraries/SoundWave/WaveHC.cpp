...
/*
  ...
  mcpDacCsHigh();
*/
  // with high frequency PWM for the PCM generation
  // we have only 8bits of data, what means we gotta 
  // loose resolution if there are 16b samples
    cli();
...
//XXX  mcpDacInit();
    ...
    // Preconfigure the sound to be off
    // this means 127 to the OCR2B
    OCR2B = 127;
...
//XXX
  // turn off the sound on the speaker
  OCR2B = 127; 
