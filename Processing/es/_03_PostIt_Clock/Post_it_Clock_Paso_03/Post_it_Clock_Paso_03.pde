...
void setup() {
  size(800, 400);   
  im[0] = loadImage("foto.jpg");   // La primera imagen va a la primera posicion del array img[]
  im[1] = loadImage("foto2.jpg");  // La segunda imagen va a la segunda posicion del array
}
